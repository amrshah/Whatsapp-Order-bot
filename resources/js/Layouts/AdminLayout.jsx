...
export default function AuthenticatedLayout({ header, children }) {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
            <nav className="border-b border-gray-800 bg-gray-900 dark:border-gray-800 dark:bg-gray-900">
                        ...
                        <div className="flex">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <Link
                                    ...
                                    className={`inline-flex items-center border-b-2 px-1 pt-1 text-sm font-medium leading-5 transition duration-150 ease-in-out focus:outline-none ${route().current('admin.dashboard') ? 'border-indigo-500 text-white focus:border-indigo-700' : 'border-transparent text-gray-300 hover:border-gray-300 hover:text-white focus:border-gray-300 focus:text-white'}`}
                                >
                                    SaaS Dashboard
                                </Link>
                                ...
                                <Link
                                    ...
                                    className={`inline-flex items-center border-b-2 px-1 pt-1 text-sm font-medium leading-5 transition duration-150 ease-in-out focus:outline-none ${route().current('admin.tenants.*') ? 'border-indigo-500 text-white focus:border-indigo-700' : 'border-transparent text-gray-300 hover:border-gray-300 hover:text-white focus:border-gray-300 focus:text-white'}`}
                                >
                                    Tenants
                                </Link>
                ...
                >
                    <div className="pt-2 pb-3 space-y-1">
                        <Link
                            href={route('admin.dashboard')}
                            className={`block w-full border-l-4 py-2 pe-4 ps-3 text-start text-base font-medium transition duration-150 ease-in-out focus:outline-none ${route().current('admin.dashboard') ? 'border-indigo-400 bg-indigo-900/50 text-indigo-200 focus:border-indigo-700 focus:bg-indigo-900 focus:text-indigo-100' : 'border-transparent text-gray-400 hover:border-gray-600 hover:bg-gray-800 hover:text-gray-200 focus:border-gray-600 focus:bg-gray-800 focus:text-gray-200'}`}
                        >
                            SaaS Dashboard
                        </Link>
